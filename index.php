...
if (isset($_POST) & !empty($_POST)) {
	...
	// Execute query
	$query = "INSERT INTO `booking` (room_no, customer_email, adults_num, children_num, check_in, check_out) VALUES ('$room_number', '$customer_email', '$adults', '$children', '$check_in', '$check_out')";
...
<div class="d-flex mt-4 mx-4">
	<h2>Welcome To Prajwal Hotel Reservation,
