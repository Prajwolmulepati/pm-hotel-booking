...
if (isset($_POST) & !empty($_POST)) {
	...
	$UpdateSql = "UPDATE `booking` SET room_no='$room_no', customer_email='$customer_email', adults_num='$adults', children_num='$children', check_in='$check_in', check_out='$check_out' WHERE id='$id' ";
